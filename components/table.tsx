...
export default function BaseTable() {
  ...
  return (
    <>
      <Table isStriped aria-label="Example meme table">
        <TableHeader>
            ...
            <>
              ...
              <ModalBody>
                {selectedMeme ? (
                  <>
                    <p>
                      <strong>ID:</strong> {selectedMeme.id}
                    </p>
                    ...
                    <p>
                      <strong>Likes:</strong> {selectedMeme.likes}
                    </p>
                    <img
              ...
              <ModalFooter>
                ...
                <Button
                  color="primary"
                  onPress={() => {
                    if (selectedMeme && selectedMeme.likes < 99) {
                      updateMeme(selectedMeme.id, {
                        likes: selectedMeme.likes + 1,
                      });
                    }
